...
\end{equation}
Bei einer verlustlosen Antenne entspricht Aperatureffizienz $\eta_\mathrm{AE}$ der Effizienz der gesamten Antenne $\eta$.
...
Die Polarisierung einer Antenne kann mit der Polarisierung der von ihr abgestrahlten EM-Welle beschrieben werden. Jedoch kann die Bauform und Ausrichtung einer Antenne zu unterschiedlichen Polarisierung innerhalb ihrer Strahlungscharakteristik führen. Demnach ist die Polarisierung einer Antenne abhängig vom Abstrahlwinkel $(\theta,\varphi)$, kann aber mit der Polarisierung der aus diesem Winkel abgestrahlten EM-Welle beschrieben werden.\cite{Balanis_2005}
...
\end{figure}
In Abbildung \ref{ZusammensetzungZirkular} sind die Komponenten des E-Feld Vektors (blauer Pfeil) dargestellt. Der E-Feld Vektor setzt sich aus zwei einzelnen linearen E-Feld Vektoren (Rot und Blau) zusammen, welche orthogonal zu einander stehen. Die Phasendifferenz zwischen den roten und blauen E-Feld Vektoren beträgt dabei $90\degree$ oder $\frac{\pi}{2}$ oder ein ungerade vielfaches davon.\cite{Balanis_2005}\newline
...
Der E-Feld Vektor setzt sich bei der elliptischen Polarisation aus zwei einzelnen linearen Komponenten zusammen. Diese können die gleiche Amplitude aufweisen, ist aber keine Voraussetzung. Wenn die beiden linearen Komponenten unterschiedliche Amplituden haben, darf die Phasendifferenz zwischen den beiden Komponenten nicht $0\degree$ oder ein vielfaches von $180\degree$ sein, da sonst der zusammengesetzte E-Feld Vektor eine lineare Polarisation aufweisen würde. Bei gleicher Amplitude darf die Phasendifferenz kein vielfaches von $90\degree$ sein, da sonst der zusammensetzte E-Feld Vektor eine zirkulare Polarisation aufweisen würde.\cite{Balanis_2005}\newline
Eine Antenne ist nur für eine Polarisationsebene ausgelegt und kann EM-Wellen weder ausstrahlen noch empfangen, wenn diese orthogonal zu ihrer eigenen Polarisation stehen.\cite{Satellite_Communications_Systems} Diese Eigenschaft macht es möglich über die gleiche Übertragungsstrecke zwei verschiedene Links mit der gleichen Frequenz $f$ zu betreiben. Dafür müssen an beiden Ende der Übertragungsstrecke zwei verschiedene Antenne mit orthogonaler Polarisation zu einander oder jeweils eine Antenne, welche beide Polarisationen unterstützt.\cite{Satellite_Communications_Systems}
