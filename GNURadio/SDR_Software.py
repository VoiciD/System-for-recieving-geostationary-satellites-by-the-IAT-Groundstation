...
class SDR_Software(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fft_band_filter = fft_band_filter = firdes.complex_band_pass(1.0, 48e4, 100, 2.7e3, 200, window.WIN_HAMMING, 6.76)
        self.demod = demod = 0
        ...
        # Create the options list
        self._demod_options = [0, 1]
        # Create the labels list
        self._demod_labels = ['FM', 'SSB']
        # Create the combo box
        ...
        self._channel_frequency_win = qtgui.RangeWidget(self._channel_frequency_range, self.set_channel_frequency, "'channel_frequency'", "eng_slider", float, QtCore.Qt.Horizontal)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(5, [20], 0, samp_rate)
        ...
        self.blocks_selector_1 = blocks.selector(gr.sizeof_gr_complex*1,ssb,0)
        ...
        self.connect((self.blocks_complex_to_real_0, 0), (self.blocks_selector_2, 1))
        ...
        self.connect((self.blocks_selector_2, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_swapiq_0, 0), (self.blocks_selector_1, 1))
        self.connect((self.freq_xlating_fir_filter_xxx_0, 0), (self.blocks_selector_1, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0, 0), (self.blocks_swapiq_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.complex_band_pass(1, self.samp_rate, 200, self.bandwidth, 500, window.WIN_HAMMING, 6.76))
    ...
    def get_fft_band_filter(self):
        return self.fft_band_filter

    def set_fft_band_filter(self, fft_band_filter):
        self.fft_band_filter = fft_band_filter
