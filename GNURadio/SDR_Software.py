...
class SDR_Software(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Create the labels list
        self._demod_labels = ['FM', 'Do not use (SSB)', 'CW', 'Do not use (SSB)', 'SSB']
        # Create the combo box
        ...
        self.connect((self.blocks_selector_0, 4), (self.freq_xlating_fir_filter_xxx_0_0_0, 0))
    ...
    def set_bandwidth(self, bandwidth):
        ...
        self.band_pass_filter_0_0.set_taps(firdes.complex_band_pass(1, 48e3, 200, (200+self.bandwidth), 500, window.WIN_HAMMING, 6.76))
