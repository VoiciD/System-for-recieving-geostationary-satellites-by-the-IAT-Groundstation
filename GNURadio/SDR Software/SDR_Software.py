...
class SDR_Software(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "SDR_Software")
        ...
        self.ssb = ssb = 0
        self.save_Audio = save_Audio = 0
        self.samp_rate = samp_rate = 1e6
        self.rf_gain = rf_gain = 0
        self.demod = demod = 0
        self.channel_frequency = channel_frequency = 433.05e6
        self.center_frequency = center_frequency = 433.2e6
        self.bandwidth = bandwidth = 2.7e3
        ...
        # Create the options list
        self._save_Audio_options = [0, 1]
        # Create the labels list
        self._save_Audio_labels = ['No', 'Yes']
        # Create the combo box
        self._save_Audio_tool_bar = Qt.QToolBar(self)
        self._save_Audio_tool_bar.addWidget(Qt.QLabel("Save Audio Strean" + ": "))
        self._save_Audio_combo_box = Qt.QComboBox()
        self._save_Audio_tool_bar.addWidget(self._save_Audio_combo_box)
        for _label in self._save_Audio_labels: self._save_Audio_combo_box.addItem(_label)
        self._save_Audio_callback = lambda i: Qt.QMetaObject.invokeMethod(self._save_Audio_combo_box, "setCurrentIndex", Qt.Q_ARG("int", self._save_Audio_options.index(i)))
        self._save_Audio_callback(self.save_Audio)
        self._save_Audio_combo_box.currentIndexChanged.connect(
            lambda i: self.set_save_Audio(self._save_Audio_options[i]))
        # Create the radio buttons
        self.top_layout.addWidget(self._save_Audio_tool_bar)
        self._rf_gain_range = qtgui.Range(0, 31.5, 0.5, 0, 200)
        ...
        # Create the options list
        self._demod_options = [0, 1, 2]
        # Create the labels list
        self._demod_labels = ['FM', 'CW', 'SSB']
        # Create the combo box
        ...
        self._channel_frequency_range = qtgui.Range(30e6, 500e6, 1, 433.05e6, 200)
        ...
        self._center_frequency_range = qtgui.Range(30e6, 500e6, 1, 433.2e6, 200)
        ...
        self._bandwidth_range = qtgui.Range(1, 200e3, 1, 2.7e3, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.freq_xlating_fir_filter_xxx_0_0_0 = filter.freq_xlating_fir_filter_ccc(1, [20], 0, samp_rate)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, [20], 0, samp_rate)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/groundstation_user/Schreibtisch/Testübertragung LSB',
            1,
            48000,
            blocks.FORMAT_WAV,
        ...
        self.blocks_selector_1 = blocks.selector(gr.sizeof_float*1,0,save_Audio)
        ...
        self.band_pass_filter_0_0_0_0 = filter.fir_filter_ccc(
            1,
        ...
        self.analog_agc2_xx_1_0_0 = analog.agc2_cc((1e-3), 0.1, 0.5, 0.1, 65536)
        self.analog_agc2_xx_0 = analog.agc2_cc((1e-3), 0.1, 0.5, 0.1, 65536)
        ...
        self.connect((self.analog_agc2_xx_1_0_0, 0), (self.blocks_complex_to_real_1_0_0, 0))
        self.connect((self.analog_fm_demod_cf_0, 0), (self.blocks_selector_2, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.band_pass_filter_0_0_0, 0), (self.blocks_selector_1_0_0, 0))
        self.connect((self.band_pass_filter_0_0_0_0, 0), (self.blocks_selector_1_0_0, 1))
        self.connect((self.blocks_complex_to_real_1, 0), (self.blocks_selector_2, 1))
        self.connect((self.blocks_complex_to_real_1_0_0, 0), (self.blocks_selector_2, 2))
        ...
        self.connect((self.blocks_selector_0, 2), (self.freq_xlating_fir_filter_xxx_0_0_0, 0))
        ...
        self.connect((self.blocks_selector_1_0_0, 0), (self.analog_agc2_xx_1_0_0, 0))
        self.connect((self.blocks_selector_2, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_selector_2, 0), (self.blocks_selector_1, 0))
        self.connect((self.blocks_selector_2, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.blocks_swapiq_0_0, 0), (self.band_pass_filter_0_0_0_0, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0, 0), (self.rational_resampler_xxx_1, 0))
        self.connect((self.freq_xlating_fir_filter_xxx_0_0_0, 0), (self.rational_resampler_xxx_0_0_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.low_pass_filter_2, 0), (self.analog_agc2_xx_0, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.analog_fm_demod_cf_0, 0))
        self.connect((self.rational_resampler_xxx_0_0_0_0, 0), (self.band_pass_filter_0_0_0, 0))
        self.connect((self.rational_resampler_xxx_0_0_0_0, 0), (self.blocks_swapiq_0_0, 0))
        self.connect((self.rational_resampler_xxx_1, 0), (self.low_pass_filter_2, 0))
    ...
    def set_save_Audio(self, save_Audio):
        self.save_Audio = save_Audio
        self._save_Audio_callback(self.save_Audio)
        self.blocks_selector_1.set_output_index(self.save_Audio)
    ...
    def set_bandwidth(self, bandwidth):
        ...
        self.band_pass_filter_0_0_0.set_taps(firdes.complex_band_pass(1, 48e3, 200, (200+self.bandwidth), 150, window.WIN_HAMMING, 6.76))
        self.band_pass_filter_0_0_0_0.set_taps(firdes.complex_band_pass(1, 48e3, 200, (200+self.bandwidth), 150, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.bandwidth, 25e3, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_2.set_taps(firdes.low_pass(1, 48e3, self.bandwidth, 150, window.WIN_HAMMING, 6.76))
